      ...
      <div className="relative flex flex-col flex-1">
        ...
        <div className="flex-1 px-6 py-10">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start max-w-6xl mx-auto">
            {/* Left Info Panel */}
            <div className="text-white/90 order-2 md:order-1">
              <h2 className="text-3xl md:text-5xl font-extrabold leading-tight drop-shadow mb-4">Welcome back to BulkMail</h2>
              <p className="text-white/80 md:text-lg">Send professional emails to multiple recipients effortlessly. Sign in to continue where you left off.</p>
              ...
              <div className="relative bg-black/60 backdrop-blur-md w-full max-w-md md:ml-auto rounded-2xl shadow-2xl border border-white/10 text-center p-6 md:p-8">
                ...
                <div className="space-y-4 text-left">
                  <input
                    ...
                    className={`p-4 rounded-lg w-full text-base bg-transparent border-2 text-white transition-all duration-200
                  ...
                  <p className="text-center text-lg text-white/80">OR</p>
                  <button className="bg-white/10 w-full py-3 rounded-lg text-white hover:bg-white/20 transition-colors">
                    Use a Sign-In code
                  </button>
                  <p className="text-white/90 underline cursor-pointer hover:text-white">Forgot password?</p>

                  <div className="flex items-center justify-center mt-4">
                    <input className="w-4 h-4 mr-2 accent-purple-600" type="checkbox" id="remember" />
                    <label htmlFor="remember" className="text-white text-sm select-none">Remember me</label>
                  </div>

                  <div className="flex flex-col sm:flex-row items-center justify-center gap-1 mt-4">
                    <p className="text-white/30 text-sm">New to BulkMail</p>
